...
var scaleBox = function(e, t) {
  var n = mul(e.startPoint, t), r = mul(e.endPoint, t), o = concat2d([n, r], 1);
  return createBox(o);
};
var ANCHORS_CONFIG = { strides: [8, 16], anchors: [2, 6] };
var NUM_LANDMARKS = 6;
function generateAnchors(e, t, n) {
  for (var r = [], o = 0; o < n.strides.length; o++) for (var i = n.strides[o], a = Math.floor((t + i - 1) / i), s = Math.floor((e + i - 1) / i), c = n.anchors[o], l = 0; l < a; l++) for (var u = i * (l + 0.5), d = 0; d < s; d++) for (var h = i * (d + 0.5), f = 0; f < c; f++) r.push([h, u]);
  return r;
}
function decodeBounds(e, t, n) {
  var r = slice(e, [0, 1], [-1, 2]), o = add2(r, t), i = slice(e, [0, 3], [-1, 2]), a = div(i, n), s = div(o, n), c = div(a, 2), l = sub(s, c), u = add2(s, c), d = mul(l, n), h = mul(u, n);
...
function flipFaceHorizontal(e, t) {
  ...
  if (e.topLeft instanceof Tensor && e.bottomRight instanceof Tensor) {
    ...
    n = [t - 1 - s, c], r = [t - 1 - u, d], null != e.landmarks && (o = e.landmarks.map(function(e2) {
...
var BlazeFaceModel = function() {
  ...
  return e.prototype.getBoundingBoxes = function(e2, t, n) {
    return void 0 === n && (n = true), __awaiter(this, void 0, void 0, function() {
      var r, o, i, a, s, c, l, u, d, h, f, p, b, m, v = this;
      return __generator(this, function(y) {
        switch (y.label) {
          case 0:
            return r = tidy(function() {
              var t2 = image.resizeBilinear(e2, [v.width, v.height]), n2 = mul(sub(div(t2, 255), 0.5), 2), r2 = v.blazeFaceModel.predict(n2), o2 = squeeze(r2), i2 = decodeBounds(o2, v.anchors, v.inputSize), a2 = slice(o2, [0, 0], [-1, 1]);
              return [o2, i2, squeeze(sigmoid(a2))];
            }), o = r[0], i = r[1], a = r[2], s = console.warn, console.warn = function() {
            }, c = image.nonMaxSuppression(i, a, this.maxFaces, this.iouThreshold, this.scoreThreshold), console.warn = s, [4, c.array()];
          case 1:
    ...
    return void 0 === t && (t = false), void 0 === n && (n = false), void 0 === r && (r = true), __awaiter(this, void 0, void 0, function() {
      var o, i, a, s, c, l, u = this;
      return __generator(this, function(d) {
        switch (d.label) {
          case 0:
            return o = getInputTensorDimensions(e2), i = o[1], a = tidy(function() {
              return e2 instanceof Tensor || (e2 = browser_exports.fromPixels(e2)), expandDims(cast(e2, "float32"), 0);
          ...
          case 1:
            return s = d.sent(), c = s.boxes, l = s.scaleFactor, a.dispose(), t ? [2, c.map(function(e3) {
              ...
              if (r) {
                var a2 = e3, s2 = a2.landmarks, c2 = a2.probability, u2 = a2.anchor, d2 = mul(add2(s2, u2), l);
...
function load(e) {
  var t = void 0 === e ? {} : e, n = t.maxFaces, r = void 0 === n ? 10 : n, o = t.inputWidth, i = void 0 === o ? 128 : o, a = t.inputHeight, s = void 0 === a ? 128 : a, c = t.iouThreshold, l = void 0 === c ? 0.3 : c, u = t.scoreThreshold, d = void 0 === u ? 0.75 : u, h = t.modelUrl;
